...
$sql = 'select id, nombre from c_categorias where id='.$id;
...
<h1 id="titulo-opcion">ACTUALIZAR CATEGORIAS</h1>
...
<form action="" class="formulario">
    ...
    <div class="container-button">
        ...
        <button type="button" onclick="updateCategorias()" class="button">GUARDAR</button> 
